...
export default function App() {
  ...
  const send = async () => {
    ...
    if (!API_KEY) {
      setError("No API key found. Add VITE_ANTHROPIC_API_KEY to your Vercel environment variables.");
      return;
    }
    ...
    try {
      ...
      const reply = data.content?.[0]?.text || "The darkness swallows your action whole. Try something else.";
